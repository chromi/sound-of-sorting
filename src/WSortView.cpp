...
void WSortView::paint(wxDC& dc, const wxSize& dcsize)
{
    ...
    static const wxPen pens[] = {
        ...
        *wxCYAN_PEN,
        ...
        wxPen(wxColour(255,255,0)),   // 17 yellow
        wxPen(wxColour(255,0,255)),   // 18 magenta
        wxPen(wxColour(255,192,128)), // 19 orange
        wxPen(wxColour(255,128,192)), // 20 pink
        wxPen(wxColour(128,192,255)), // 21 darker cyan
        wxPen(wxColour(192,255,128)), // 22 darker green
        wxPen(wxColour(192,128,255)), // 23 purple
        wxPen(wxColour(128,255,192)), // 24 light green
        wxPen(wxColour(128,128,255)), // 25 blue
        wxPen(wxColour(192,128,192)), // 26 dark purple
        wxPen(wxColour(128,192,192)), // 27 dark cyan
        wxPen(wxColour(192,192,128)), // 28 dark yellow
        wxPen(wxColour(0,128,255)),   // 29 blue/cyan mix
    };
    ...
    static const wxBrush brushes[] = {
        ...
        *wxCYAN_BRUSH,
        ...
        wxBrush(wxColour(255,255,0)),   // 17 yellow
        wxBrush(wxColour(255,0,255)),   // 18 magenta
        wxBrush(wxColour(255,192,128)), // 19 orange
        wxBrush(wxColour(255,128,192)), // 20 pink
        wxBrush(wxColour(128,192,255)), // 21 darker cyan
        wxBrush(wxColour(192,255,128)), // 22 darker green
        wxBrush(wxColour(192,128,255)), // 23 purple
        wxBrush(wxColour(128,255,192)), // 24 light green
        wxBrush(wxColour(128,128,255)), // 25 blue
        wxBrush(wxColour(192,128,192)), // 26 dark purple
        wxBrush(wxColour(128,192,192)), // 27 dark cyan
        wxBrush(wxColour(192,192,128)), // 28 dark yellow
        wxBrush(wxColour(0,128,255)),   // 29 blue/cyan mix
    };
