...
const struct AlgoEntry g_algolist[] =
{
	...
	1000000, UINT_MAX, _("Gap sequence: 1, N^(1/5), N^(7/15) perturbed to ensure coprime.\n") },
	{ _("Shell Sort (Janson 1996 4-pass)"), &ShellSort_Janson96Mod,
	1000000, UINT_MAX, _("Gap sequence: 1, N^(1/5), N^(7/15), N^(11/15) perturbed to ensure coprime.\n") },
	{ _("Shell Sort (Uniform 3-pass)"), &ShellSort_Uniform3,
	1000000, UINT_MAX, _("Gap sequence: 1, N^(1/3), N^(2/3) perturbed to ensure coprime.\n") },
...
//	_("In-place merge sort variant which uses splaysort to collect ascending runs, then merges adjacent pairs of runs using the bitonic principle.") },
	...
	wxEmptyString },
	{ _("Martini Sort"), &MartiniSort, UINT_MAX, UINT_MAX,
	wxEmptyString },
